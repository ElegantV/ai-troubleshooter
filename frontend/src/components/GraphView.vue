<template>
  <div v-if="loaded">
    <div class="panel">
      <h3>
        <el-icon class="h3-ico"><Compass /></el-icon>三大关联能力是什么
      </h3>
    ...
    <div class="panel">
      <h3>
        <el-icon class="h3-ico"><TrendCharts /></el-icon>血缘 × 链路关系图（当前知识库真实数据）
      </h3>
    ...
    <div class="panel">
      <h3>
        <el-icon class="h3-ico"><Aim /></el-icon>关联分析真实演示（基于知识库当前数据）
      </h3>
